...
export const products = {
  fr: {
    ...
    swift: {
      ...
      subtitle: 'Le socle de messagerie financière de la banque moderne',
      eyebrow: 'MT • MX • ISO 20022 • CBPR+',
      hero: 'Le socle de messagerie financière pour une banque moderne.',
      body: 'SWIFT+ centralise la gestion des messages financiers de la banque dans une plateforme unique : MT, MX, ISO 20022 et CBPR+.',
      capabilities: ['Messagerie MT / MX', 'Transformation ISO 20022', 'Validation des messages', 'Routage fonctionnel', 'Supervision & investigation', 'Traçabilité de bout en bout', 'Gestion des Standards Releases'],
      flow: ['Créer', 'Transformer', 'Valider', 'Router', 'Envoyer / Recevoir', 'Superviser', 'Tracer'],
      tags: ['MT / MX', 'ISO 20022', 'CBPR+', 'SR2026', 'Standards Releases'],
    },
  },
  en: {
    ibansys: {
    ...
    swift: {
      title: 'SWIFT+ Messaging Hub',
      subtitle: 'The Financial Messaging Backbone for Modern Banking',
      eyebrow: 'MT • MX • ISO 20022 • CBPR+',
      hero: 'The Financial Messaging Backbone for Modern Banking.',
      body: 'SWIFT+ centralises the bank’s financial messages in one platform: MT, MX, ISO 20022 and CBPR+.',
      capabilities: ['MT / MX Messaging', 'ISO 20022 Transformation', 'Message Validation', 'Functional Routing', 'Monitoring & Investigation', 'End-to-End Traceability', 'Standards Release Management'],
      flow: ['Create', 'Transform', 'Validate', 'Route', 'Send / Receive', 'Monitor', 'Trace'],
      tags: ['MT / MX', 'ISO 20022', 'CBPR+', 'SR2026', 'Standards Releases'],
    },
  },
} as const
